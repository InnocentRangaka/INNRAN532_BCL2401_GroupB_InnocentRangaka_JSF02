...
<div class="h-full flex justify-center items-center bg-opacity-70">
    <div class="container bg-white rounded-lg p-4 w-full mt-6 sm:mt-8 lg:flex lg:items-start border border-gray-200 dark:border-gray-700 ">
        ...
        >
            ...
            <!-- Image Placeholder -->
            <div class="flex items-center justify-center h-96 bg-gray-300 rounded dark:bg-gray-700">
                <svg
            ...
            <div>
                <!-- Title Placeholder -->
                <div class="h-9 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
                <div class="h-9 w-3/4 bg-gray-200 rounded-full dark:bg-gray-700 mb-5"></div>
                ...
                <!-- Button Placeholder -->
                <div class="h-11  w-1/2 bg-gray-200 rounded-lg dark:bg-gray-700 mb-5"></div>

                <!-- Description Placeholder -->
                <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
                <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
                <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5"></div>
                <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-3/4 mb-2.5"></div>
